package me.rustbreaker.townysethome;
    ...
    public void onHomeCommand(final PlayerCommandPreprocessEvent e) {
        ...
        if (e.getMessage().contains("/sethome")) {
            try {
                ...
                player.sendMessage(ChatColor.GOLD + "[Tip] " + ChatColor.BLUE + "Make a town with " + ChatColor.GOLD + "/t new [name]" + ChatColor.BLUE + " or join one by asking around for an invite");
                e.setCancelled(true);
            }
        }
    }
